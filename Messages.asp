...
<link rel="icon" href="images/EpistleLogo.png" type="image/icon type">
...
<body background="images/Messages.png">
<div id="Header">
    <ul>
                ...
                <div id="MessageSummary">
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <button id="SearchButton"><div id="search"><img src="images/SearchImageMain.png" alt="Search"></div></button>
                            </td>
                        </tr>
                        </form>
...
<div id="MainUserMessages">
    ...
    <div id="PreviousMessages">
        <div id="GoToTextField">
            <a href="#EndOfMessagesDiv"><img src="images/GoToTextFieldButtonMain.png" alt="Go To Text Field"></img></a>
        </div>
        <div id="MessageList">
                    <%
                    Dim con2,rs2
    ...
    <button id="SubmitButton"><img src="images/SendImageIcon.png" alt="SendMessage" id="SendMessageIconId"/></button>
    </div>
    </div>
</div>
</form> 
