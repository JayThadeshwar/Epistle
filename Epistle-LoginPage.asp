...
<body background="images/Organizer Desktop Wallpaper.png">
    ...
    <form method="POST" action="Epistle-Login.asp">
        ...
        <table id="MainTable">
            ...
            <tr>
                ...
                <td><div id="ShowPassword"><img src="images/EyeIcon.png" alt="Show Password" id="ShowPasswordImage" /></img></div></td>
            </tr>
            <tr>
                <td>
                  <div id="RemberMeDiv">
...
<script>
 $(document).ready(function(){
    ...
    $("#ShowPassword").mouseover(function(){
        ...
        document.getElementById("ShowPasswordImage").src="images/CloseEyeIcon.png";
    });
    
    $("#ShowPassword").mouseleave(function(){
        $("#LoginKeyValueDiv").hide();
        $("#LoginKeyDiv").show();
         document.getElementById("ShowPasswordImage").src="images/EyeIcon.png";
    });
